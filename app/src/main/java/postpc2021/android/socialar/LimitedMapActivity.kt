...
class LimitedMapActivity : AppCompatActivity(), OnMapReadyCallback, PermissionsListener  {
    ...
    fun initializeMap(savedInstanceState: Bundle?){
        ...
        setContentView(R.layout.activity_limited_map)
    ...
    private fun drawMarkersInMap(symbolManager: SymbolManager){
        ...
        this.locations = intent.extras!!.get("messages") as ArrayList<MessageData>
